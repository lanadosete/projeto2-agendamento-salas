...
-- =========================
-- 2) Recorrência (AGORA COM PROFISSIONAL)
-- =========================
...
-- =========================
-- 4) Regra: Impedir conflito de horário
-- =========================
...
-- =========================
-- 5) Regra: Cancelamento AVULSO até 24h antes
-- =========================
...
SELECT
  ...
  SUM(
    (EXTRACT(EPOCH FROM (hr.data_fim - hr.data_inicio)) / 3600.0)
    * s.valor_hora
  ) AS total_valor
FROM horario_reservado hr
